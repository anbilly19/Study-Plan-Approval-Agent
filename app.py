...
from main import init_eval_agents, evaluate_study_plan, GPT_4O
...
if not os.getenv("OPENAI_API_KEY"):
    raise RuntimeError("Set OPENAI_API_KEY before starting the API")
...
def evaluate(req: EvaluateRequest):
    ...
    try:
        result = evaluate_study_plan(study_plan=sp, hitl=False, model_name=GPT_4O)
