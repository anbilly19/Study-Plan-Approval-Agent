...
class EvaluationTools:
    ...
    def _workload_score_impl(num_courses: int) -> int:
        """Calculate workload score based on number of courses.
    ...
    @staticmethod
    def _weighted_score_impl(scheduling_score: int, alignment_score: int, workload_score: int) -> Dict[str, Any]:
        """Calculate weighted average score and determine color code.
